...
void ScreenManager::Start(int argc, char **argv)
{
    ...
    glutDisplayFunc(RenderSceneCBWrapper);
    glutIdleFunc(RenderSceneCBWrapper);
    glutReshapeFunc(ReshapeCBWrapper);
    glutSpecialFunc(ProcessSpecialKeysCBWrapper);
    glutKeyboardFunc(ProcessKeysCBWrapper);
